<?php
    ...
    class Controller{
        ...
        public function __construct($view, $chansons,$accounts){
            ...
            $this->authentication = new AuthenticationManager($accountList);
        ...
        public function saveNewChanson(array $data){   
            $chansonBuilder= new ChansonBuilder($data);
        ...
        public function newChanson($data= array()){
            if(key_exists("currentNewChanson", $_SESSION)){
                ...
                return new ChansonBuilder($data);
            }
        }
        ...
        public function updateChansonBuilder($id){
            ...
            if(key_exists($idUpdateElt, $_SESSION)){
                ...
                return new ChansonBuilder($data->getArray());
            }
        }
